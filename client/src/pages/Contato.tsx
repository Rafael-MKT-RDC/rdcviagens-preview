            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-12">
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-8 pb-8 text-center">
                  <div className="w-16 h-16 bg-[#E8F4FA] rounded-full flex items-center justify-center mx-auto mb-5">
                    <Globe className="w-8 h-8 text-[#001A9E]" />
                  </div>
                  <h3 className="font-bold text-xl text-[#2D2D2D] mb-4">Chat</h3>
                  <a href="https://rdcviagens.com.br" target="_blank" rel="noopener noreferrer">
                    <Button className="bg-[#001A9E] hover:bg-[#001070] w-full">
                      Acessar o chat
                    </Button>
                  </a>
                </CardContent>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-8 pb-8 text-center">
                  <div className="w-16 h-16 bg-[#D4F5E9] rounded-full flex items-center justify-center mx-auto mb-5">
                    <svg className="w-9 h-9 text-[#06D6A0]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://api.whatsapp.com/send?phone=551140034910" target="_blank" rel="noopener noreferrer">
                    <Button className="bg-[#059E78] hover:bg-green-700 w-full">
                      Enviar mensagem
                    </Button>
                  </a>
                </CardContent>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow ring-2 ring-[#FFCC80]">
                <CardContent className="pt-8 pb-8 text-center">
                  <div className="w-16 h-16 bg-[#00148A] rounded-full flex items-center justify-center mx-auto mb-5">
                    <Headset className="w-8 h-8 text-[#FF9100]" />
                  </div>
                  <h3 className="font-bold text-xl text-[#2D2D2D] mb-2">Televendas</h3>
                  <a href="tel:08000552600" className="block">
                    <p className="text-2xl font-bold text-[#001A9E] mb-1">0800-055-2600</p>
                  </a>
                  <p className="text-xs text-[#06D6A0] font-semibold mb-4">Ligação gratuita</p>
                  <a href="tel:08000552600">
                    <Button className="bg-[#FF9100] hover:bg-[#E68200] w-full">
                      Ligar agora
                    </Button>
                  </a>
                </CardContent>
