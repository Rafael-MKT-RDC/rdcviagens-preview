...
export default defineType({ name:"paginaParcerias", title:"Página RDC Parcerias", type:"document",
  ...
  fields:[
    t("heroBadge","Selo","hero"),t("heroTitulo","Título","hero"),t("heroDestaque","Destaque","hero"),t("heroSub1","Subtítulo 1","hero",2),t("heroSub2","Subtítulo 2","hero",2),t("heroCta","Botão","hero"),
