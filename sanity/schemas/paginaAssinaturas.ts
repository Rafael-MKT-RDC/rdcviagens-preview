...
export default defineType({
  ...
  fields: [
    ...
    t('agenciaBadge','Selo','agencia'), t('agenciaTitulo','Título','agencia'), t('agenciaTexto','Texto','agencia',3), t('agenciaCta','Botão','agencia'), t('agenciaCtaLink','Link do botão','agencia'),
    t('faqTitulo','Título','faq'), t('faqSubtitulo','Subtítulo','faq',2),
    t('ctaTitulo','Título','cta'), t('ctaTexto','Texto','cta',2), t('ctaBotao1','Botão 1','cta'), t('ctaBotao2','Botão 2','cta'), t('ctaBotao2Link','Link do botão 2 (WhatsApp)','cta'),
  ],
