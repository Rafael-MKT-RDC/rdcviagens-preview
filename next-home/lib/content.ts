...
export const redesHoteleiras = [
  { nome: "Accor", descricao: "Ibis, Novotel, Mercure, Pullman, Sofitel" },
  { nome: "Atlântica", descricao: "Comfort, Quality, Radisson, Four Points" },
  { nome: "Hilton", descricao: "Hampton, DoubleTree, Conrad, Waldorf Astoria" },
  { nome: "Hyatt", descricao: "Grand Hyatt, Hyatt Regency, Park Hyatt" },
  { nome: "IHG", descricao: "Holiday Inn, Crowne Plaza, InterContinental" },
  { nome: "Laghetto", descricao: "Laghetto Hotéis & Resorts" },
  { nome: "Marriott", descricao: "Courtyard, Sheraton, W Hotels, Ritz-Carlton" },
  { nome: "Meliá", descricao: "Meliá, Tryp, Sol, Innside" },
  { nome: "Vila Galé", descricao: "Vila Galé Resorts, Vila Galé Collection" },
  { nome: "WAM", descricao: "WAM Hotéis & Resorts" },
  { nome: "Wyndham", descricao: "Ramada, Tryp, Howard Johnson, Days Inn" },
];
