...
export default defineType({ name:'paginaEmpresas', title:'Página Soluções Corporativas', type:'document',
  ...
  fields:[
    t('heroBadge','Selo','hero'),t('heroTitulo','Título','hero'),t('heroDestaque','Destaque','hero'),t('heroSubtitulo','Subtítulo','hero',2),t('heroCta','Botão','hero'),t('heroCtaLink','Link do botão','hero'),
