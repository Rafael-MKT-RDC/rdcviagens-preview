...
export default defineType({
  ...
  fields: [
    ...
    txt('sobreCtaLink', 'Link do botão', 'sobre'),
    ...
    txt('redesCtaLink', 'Link do botão', 'redes'),
    ...
    txt('assinaturasCtaLink', 'Link do botão', 'assinaturas'),
    ...
    txt('agenciaCtaLink', 'Link do botão', 'agencia'),
    ...
    txt('corpCtaLink', 'Link do botão geral', 'corp'),
