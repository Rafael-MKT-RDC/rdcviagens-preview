              ...
              {solutions.map((solution, index) => (
                <div key={solution.id} id={solution.id} className="grid lg:grid-cols-2 gap-12 items-center">
                  <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={solution.logo} alt={solution.title} className="h-12 md:h-14 w-auto mb-6" />
                  ...
                  <div className={index % 2 === 1 ? "lg:order-1" : ""}>
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
                      ...
                      <div className="absolute bottom-6 left-6 right-6"><Badge className="bg-[#FF9100] text-white border-0">{solution.title}</Badge></div>
                    </div>
                  </div>
                </div>
              ))}
